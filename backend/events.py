        ...
        "messages": [
            {
                ...
                "content": (
                    ...
                    "- State [Temporal Consistency] as the tag\n"
                    "- Quote the specific sentence(s) or phrase(s) that contain the violation\n"
                    "- Explain WHY this is a temporal contradiction, referencing which category it falls under\n"
                    "- Reference the contradicting passage or established timeline that it conflicts with\n\n"
                    "Group violations by chapter. Write in clear, human-readable paragraphs.\n\n"
